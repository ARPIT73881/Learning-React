...
function Card(props) {
  const { title, brand, image, price, description } = props;
  return (
    <div className="card">
...
//     image="https://www.91-img.com/gallery_images_uploads/3/d/3df5ca6a9b470f715b085991144a5b76e70da975.JPG?tr=h-630,c-at_max,q-80"
//   />
// );
